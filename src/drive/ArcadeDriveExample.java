...
public class ArcadeDriveExample 
{
	...
	private static double fakeInputY=0;
	...
	public static void main(String[] args)
	{
		...
		if (fakeInputX>0||fakeInputY>0||fakeInputX<0||fakeInputY<0)
		{
			...
			// this is where we would pass the motor output to the robot if there is input
		...
		{
			// this is where we would pass the motor output to the robot if there is no input
			System.out.println("Left motor: " + outputLeftMotor + " Right Motor: " + outputRightMotor );
		}
