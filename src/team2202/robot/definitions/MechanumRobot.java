...
public class MechanumRobot extends RobotDefinitionBase {
	...
	protected void loadManualDefinitions() {
		...
		_properties.put("BRMOTORPIN", "3");// r
	...
	public Map<String, IControl> loadControlObjects() {
		...
		Global.controllers = (ControlBase)new HoenhiemControl();
...
//		IMotor BR = new JaguarMotor(getInt("BRMOTORPIN"), false);
		...
		IDrive AD = new MechanumDrive(getInt("BLMOTORPIN"), getInt("BRMOTORPIN"), getInt("FRMOTORPIN"),
				getInt("FLMOTORPIN"), 0);

		// Create the autonomous command list maker, and command runner
		// CommandListMaker CLM = new CommandListMaker();
		// CommandRunner CR = new CommandRunner(CLM.makeList1(),"TIM"); // makes
		// list one for the TIM robot
